...
Installation: Extract the latest release into your /addons folder
To Update: Extract the latest release into your /addons folder and OVERWRITE the old files. DO NOT DELETE YOUR EXISTING "anglin" FOLDER OR YOU WILL LOSE YOUR STATISTICS.
