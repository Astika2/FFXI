...
-- ==============================
-- Helper: Write an error message to the FFXI chatlog
-- ==============================
local function print_error(msg)
    -- Color code 68 = bright red in Ashita's chat color table
    AshitaCore:GetChatManager():QueueCommand(1,
        string.format('/echo \x1F\x44[Anglin] %s\x1E', msg)
    )
end

-- ==============================
-- Helper: Ensure the data directory exists and is writable.
