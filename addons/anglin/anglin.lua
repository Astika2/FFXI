...
local fishingGuide = {
	...
	{ name = "Bastore Bream", skill = 86, location = "East Sarutabaruta, Port Bastok, Port Windurst, Sea Serpent Grotto, South Gustaberg, West Sarutabaruta", bait = "Shrimp Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Bastore Sardine", skill = 9, location = "Batallia Downs, Bibiki Bay, Cape Teriggan, East Sarutabaruta, Kazham, Lower Jeuno, Manaclipper, Mhaura, Norg, Port Bastok, Port Jeuno, Port Windurst, Sea Serpent Grotto, Selbina, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates), South Gustaberg, Valkurm Dunes, West Sarutabaruta", bait = "Sabiki Rig", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Bibiki Urchin", skill = 3, location = "Bibiki Bay, Manaclipper", bait = "Any", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Bibikibo", skill = 8, location = "Bibiki Bay, Manaclipper", bait = "Fly Lure", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Black Sole", skill = 96, location = "Batallia Downs, Beaucedine Glacier, Lower Jeuno, Port Jeuno, Qufim Island, Sauromugue Champaign", bait = "Sinking Minnow", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Bladefish", skill = 71, location = "Bibiki Bay, East Sarutabaruta, Manaclipper, South Gustaberg, West Sarutabaruta", bait = "Meatball, Slice of Bluetail", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Bluetail", skill = 55, location = "Batallia Downs, Beaucedine Glacier, Bibiki Bay, Buburimu Peninsula, Den of Rancor, East Sarutabaruta, Manaclipper, Qufim Island, Sauromugue Champaign, Sea Serpent Grotto, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates), West Sarutabaruta", bait = "Minnow", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Cheval Salmon", skill = 21, location = "East Ronfaure, Ghelsba Outpost, Jugner Forest", bait = "Fly Lure", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Coral Butterfly", skill = 40, location = "Den of Rancor, Kazham, Norg, Sea Serpent Grotto", bait = "Worm Lure", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Crescent Fish", skill = 69, location = "Dragon's Aery, East Sarutabaruta, Yuhtunga Jungle", bait = "Fly Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Crystal Bass", skill = 35, location = "Jugner Forest, The Sanctuary of Zi'Tah", bait = "Minnow, Sinking Minnow", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Dark Bass", skill = 33, location = "Bastok Markets, Bhaflau Thickets, Caedarva Mire, Carpenters' Landing, Davoi, Giddeus, Jugner Forest, La Theine Plateau, Lufaise Meadows, Misareaux Coast, Phanauet Channel, Rolanberry Fields, The Boyahda Tree, The Sanctuary of Zi'Tah, Wajaom Woodlands, West Sarutabaruta", bait = "Ball of Sardine Paste, Ball of Trout Paste, Minnow", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Dil", skill = 96, location = "Talacca Cove", bait = "Slice of Cod", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Elshimo Frog", skill = 30, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Fly Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Elshimo Newt", skill = 60, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Frog Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Emperor Fish", skill = 91, location = "Beaucedine Glacier, Jugner Forest, Lufaise Meadows, The Boyahda Tree", bait = "Ball of Sardine Paste, Ball of Trout Paste, Peeled Crayfish", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Gavial Fish", skill = 81, location = "Gusgen Mines, North Gustaberg, Western Altepa Desert", bait = "Lizard Lure, Meatball", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Giant Chirai", skill = 110, location = "The Boyahda Tree", bait = "Lufaise Fly", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Gigant Squid", skill = 91, location = "Beaucedine Glacier, Qufim Island", bait = "Minnow, Slice of Cod", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Gold Lobster", skill = 46, location = "Den of Rancor, East Sarutabaruta, South Gustaberg, West Sarutabaruta", bait = "Sinking Minnow", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Grimmonite", skill = 90, location = "Sea Serpent Grotto", bait = "Shrimp Lure", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Icefish", skill = 49, location = "Beaucedine Glacier", bait = "Sabiki Rig", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Jungle Catfish", skill = 80, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Ball of Sardine Paste, Ball of Trout Paste, Minnow", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Lik", skill = 140, location = "Lufaise Meadows", bait = "Minnow, Sinking Minnow, Dwarf Pugil", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Monke-Onke", skill = 51, location = "East Sarutabaruta, Giddeus, Yhoator Jungle, Yuhtunga Jungle", bait = "Shrimp Lure", rod = "Composite Fishing Rod", type = "Fish" },
	{ name = "Moorish Idol", skill = 26, location = "Bibiki Bay, Manaclipper", bait = "Shrimp Lure, Worm Lure", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Muddy Siredon", skill = 18, location = "Carpenters' Landing, Phanauet Channel", bait = "Frog Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Nebimonite", skill = 27, location = "Sea Serpent Grotto, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Ball of Crayfish Paste", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Ogre Eel", skill = 35, location = "East Sarutabaruta, South Gustaberg, West Sarutabaruta", bait = "Shrimp Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Phanauet Newt", skill = 4, location = "Carpenters' Landing, Phanauet Channel", bait = "Fly Lure", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Pipira", skill = 29, location = "East Sarutabaruta, Windurst Walls, Windurst Waters, Windurst Woods, Yhoator Jungle, Yuhtunga Jungle", bait = "Minnow", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Ryugu Titan", skill = 150, location = "Den of Rancor, Manaclipper, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Slice of Cod", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Shall Shell", skill = 53, location = "Bibiki Bay, Buburimu Peninsula, Cape Teriggan, Valkurm Dunes", bait = "Robber Rig", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Shining Trout", skill = 37, location = "Carpenters' Landing, East Ronfaure, Ghelsba Outpost, Jugner Forest, Phanauet Channel", bait = "Fly Lure, Minnow, Sinking Minnow", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Silver Shark", skill = 76, location = "Batallia Downs, Sauromugue Champaign, Sea Serpent Grotto, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Meatball", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Takitaro", skill = 101, location = "Davoi, Misareaux Coast", bait = "Fly Lure", rod = "Composite Fishing Rod", type = "Fish" },
	{ name = "Tavnazian Goby", skill = 75, location = "Lufaise Meadows, Misareaux Coast", bait = "Minnow", rod = "Halcyon Rod", type = "Fish" },
	{ name = "Three-Eyed Fish", skill = 79, location = "Qufim Island", bait = "Minnow, Slice of Cod", rod = "Composite Fishing Rod", type = "Fish" },
	...
	{ name = "Trilobite", skill = 59, location = "Bibiki Bay, Manaclipper", bait = "Worm Lure", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Vongola Clam", skill = 53, location = "Bibiki Bay, Manaclipper", bait = "Ball of Crayfish Paste, Peeled Crayfish", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Zebra Eel", skill = 71, location = "Den of Rancor", bait = "Shrimp Lure, Slice of Sardine", rod = "Halcyon Rod", type = "Fish" },
	...
	{ name = "Coral Fragment", skill = 74, location = "Bibiki Bay, Den of Rancor, Korroloka Tunnel, Labyrinth of Onzozo, Sea Serpent Grotto", bait = "Any", rod = "Any", type = "Item" },
	{ name = "Damp Scroll", skill = 20, location = "Sea Serpent Grotto", bait = "Any", rod = "Any", type = "Item" },
	...
	{ name = "Norg Shell", skill = 14, location = "Sea Serpent Grotto", bait = "Any", rod = "Any", type = "Item" },
