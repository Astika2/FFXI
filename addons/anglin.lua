...
-- Fishing guide data
local fishingGuide = {
	{ name = "Ahtapot", skill = 90, location = "Arrapago Reef, Nashmau, Talacca Cove", bait = "Ball of Crayfish Paste, Peeled Lobster, Shrimp Lure", rod = "Composite Fishing Rod" },
	{ name = "Alabaligi", skill = 37, location = "Bhaflau Thickets, Mamook, Wajaom Woodlands", bait = "Ball of Sardine Paste, Ball of Trout Paste, Fly Lure, Minnow, Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Armored Pisces", skill = 108, location = "Oldton Movalpolos", bait = "Frog Lure, Meatball, Minnow, Sinking Minnow", rod = "Composite Fishing Rod" },
	{ name = "Bastore Bream", skill = 86, location = "East Sarutabaruta, Port Bastok, Port Windurst, Sea Serpent Grotto, South Gustaberg, West Sarutabaruta", bait = "Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Bastore Sardine", skill = 9, location = "Batallia Downs, Bibiki Bay, Cape Teriggan, East Sarutabaruta, Kazham, Lower Jeuno, Manaclipper, Mhaura, Norg, Port Bastok, Port Jeuno, Port Windurst, Sea Serpent Grotto, Selbina, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates), South Gustaberg, Valkurm Dunes, West Sarutabaruta", bait = "Sabiki Rig", rod = "Halcyon Rod" },
	{ name = "Betta", skill = 68, location = "Mamook", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Bhefhel Marlin", skill = 61, location = "Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Slice of Bluetail", rod = "Composite Fishing Rod" },
	{ name = "Bibiki Urchin", skill = 3, location = "Bibiki Bay, Manaclipper", bait = "Any", rod = "Halcyon Rod" },
	{ name = "Bibikibo", skill = 8, location = "Bibiki Bay, Manaclipper", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Black Eel", skill = 47, location = "Bastok Markets, Gusgen Mines, Korroloka Tunnel, North Gustaberg, Oldton Movalpolos, Palborough Mines, Zeruhn Mines", bait = "Ball of Crayfish Paste, Shell Bug", rod = "Halcyon Rod" },
	{ name = "Black Ghost", skill = 88, location = "Caedarva Mire", bait = "Minnow", rod = "Halcyon Rod" },
	{ name = "Black Sole", skill = 96, location = "Batallia Downs, Beaucedine Glacier, Lower Jeuno, Port Jeuno, Qufim Island, Sauromugue Champaign", bait = "Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Bladefish", skill = 71, location = "Bibiki Bay, East Sarutabaruta, Manaclipper, South Gustaberg, West Sarutabaruta", bait = "Meatball, Slice of Bluetail", rod = "Composite Fishing Rod" },
	{ name = "Blindfish", skill = 28, location = "Aydeewa Subterrane, Oldton Movalpolos", bait = "Ball of Insect Paste", rod = "Halcyon Rod" },
	{ name = "Bluetail", skill = 55, location = "Batallia Downs, Beaucedine Glacier, Bibiki Bay, Buburimu Peninsula, Den of Rancor, East Sarutabaruta, Manaclipper, Qufim Island, Sauromugue Champaign, Sea Serpent Grotto, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates), West Sarutabaruta", bait = "Minnow", rod = "Halcyon Rod" },
	{ name = "Caedarva Frog", skill = 30, location = "Caedarva Mire", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Cave Cherax", skill = 130, location = "Aydeewa Subterrane, Kuftal Tunnel, Quicksand Caves", bait = "Meatball, Rotten Meat", rod = "Composite Fishing Rod" },
	{ name = "Cheval Salmon", skill = 21, location = "East Ronfaure, Ghelsba Outpost, Jugner Forest", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Cone Calamary", skill = 48, location = "Batallia Downs, Beaucedine Glacier, Bibiki Bay, Manaclipper, Qufim Island, Sauromugue Champaign, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Minnow", rod = "Halcyon Rod" },
	{ name = "Copper Frog", skill = 16, location = "Bastok Mines, Eastern Altepa Desert, Gusgen Mines, Korroloka Tunnel, North Gustaberg, Oldton Movalpolos, Palborough Mines, Pashhow Marshlands, Zeruhn Mines", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Coral Butterfly", skill = 40, location = "Den of Rancor, Kazham, Norg, Sea Serpent Grotto", bait = "Worm Lure", rod = "Halcyon Rod" },
	{ name = "Crayfish", skill = 7, location = "Al Zahbi, Bastok Markets, Bastok Mines, Bostaunieux Oubliette, Caedarva Mire, Carpenters' Landing, Castle Oztroja, Dangruf Wadi, Davoi, Dragon's Aery, East Ronfaure, East Sarutabaruta, Eastern Altepa Desert, Ghelsba Outpost, Giddeus, Gusgen Mines, Jugner Forest, Korroloka Tunnel, La Theine Plateau, Mamook, North Gustaberg, Northern San d'Oria, Oldton Movalpolos, Ordelle's Caves, Palborough Mines, Pashhow Marshlands, Phanauet Channel, Phomiuna Aqueducts, Port San d'Oria, Quicksand Caves, Rabao, Ranguemont Pass, Rolanberry Fields, Ru'Aun Gardens, Tavnazian Safehold, Temple of Uggalepih, The Boyahda Tree, The Shrine of Ru'Avitau, West Ronfaure, West Sarutabaruta, Western Altepa Desert, Windurst Walls, Windurst Waters, Windurst Woods, Yhoator Jungle, Yughott Grotto, Yuhtunga Jungle, Zeruhn Mines", bait = "Slice of Moat Carp", rod = "Halcyon Rod" },
	{ name = "Crescent Fish", skill = 69, location = "Dragon's Aery, East Sarutabaruta, Yuhtunga Jungle", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Crystal Bass", skill = 35, location = "Jugner Forest, The Sanctuary of Zi'Tah", bait = "Minnow, Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Dark Bass", skill = 33, location = "Bastok Markets, Bhaflau Thickets, Caedarva Mire, Carpenters' Landing, Davoi, Giddeus, Jugner Forest, La Theine Plateau, Lufaise Meadows, Misareaux Coast, Phanauet Channel, Rolanberry Fields, The Boyahda Tree, The Sanctuary of Zi'Tah, Wajaom Woodlands, West Sarutabaruta", bait = "Ball of Sardine Paste, Ball of Trout Paste, Minnow", rod = "Halcyon Rod" },
	{ name = "Dil", skill = 96, location = "Talacca Cove", bait = "Slice of Cod", rod = "Halcyon Rod" },
	{ name = "Elshimo Frog", skill = 30, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Elshimo Newt", skill = 60, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Frog Lure", rod = "Halcyon Rod" },
	{ name = "Emperor Fish", skill = 91, location = "Beaucedine Glacier, Jugner Forest, Lufaise Meadows, The Boyahda Tree", bait = "Ball of Sardine Paste, Ball of Trout Paste, Peeled Crayfish", rod = "Composite Fishing Rod" },
	{ name = "Fat Greedie", skill = 24, location = "Selbina", bait = "Ball of Crayfish Paste, Lugworm, Minnow, Sinking Minnow, Slice of Sardine, Worm Lure", rod = "Halcyon Rod" },
	{ name = "Forest Carp", skill = 20, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Ball of Insect Paste", rod = "Halcyon Rod" },
	{ name = "Gavial Fish", skill = 81, location = "Gusgen Mines, North Gustaberg, Western Altepa Desert", bait = "Lizard Lure, Meatball", rod = "Composite Fishing Rod" },
	...
	{ name = "Giant Chirai", skill = 110, location = "The Boyahda Tree", bait = "Lufaise Fly", rod = "Composite Fishing Rod" },
	{ name = "Giant Donko", skill = 50, location = "Eastern Altepa Desert, Kuftal Tunnel, Rabao, Western Altepa Desert", bait = "Peeled Crayfish", rod = "Composite Fishing Rod" },
	{ name = "Gigant Squid", skill = 91, location = "Beaucedine Glacier, Qufim Island", bait = "Minnow, Slice of Cod", rod = "Composite Fishing Rod" },
	{ name = "Gold Carp", skill = 56, location = "Bastok Markets, Davoi, East Ronfaure, Ghelsba Outpost, Gusgen Mines, Jugner Forest, Lufaise Meadows, Misareaux Coast, North Gustaberg, Northern San d'Oria, Phanauet Channel, Port San d'Oria, Windurst Walls, Windurst Waters, Windurst Woods", bait = "Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Gold Lobster", skill = 46, location = "Den of Rancor, East Sarutabaruta, South Gustaberg, West Sarutabaruta", bait = "Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Greedie", skill = 14, location = "Cape Teriggan, Lufaise Meadows, Misareaux Coast, Selbina, Valkurm Dunes", bait = "Minnow", rod = "Halcyon Rod" },
	{ name = "Grimmonite", skill = 90, location = "Sea Serpent Grotto", bait = "Shrimp Lure", rod = "Composite Fishing Rod" },
	{ name = "Gugru Tuna", skill = 41, location = "Manaclipper, Open sea route to Al Zahbi, Open sea route to Mhaura, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Sinking Minnow", rod = "Composite Fishing Rod" },
	{ name = "Gugrusaurus", skill = 140, location = "Manaclipper, Open sea route to Al Zahbi, Open sea route to Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina (with Pirates)", bait = "Meatball", rod = "Composite Fishing Rod" },
	{ name = "Gurnard", skill = 26, location = "Open sea route to Al Zahbi, Open sea route to Mhaura", bait = "Ball of Crayfish Paste, Slice of Sardine", rod = "Halcyon Rod" },
	{ name = "Hamsi", skill = 9, location = "Aht Urhgan Whitegate, Mount Zhayolm, Silver Sea route to Al Zahbi, Silver Sea route to Nashmau", bait = "Sabiki Rig", rod = "Halcyon Rod" },
	{ name = "Icefish", skill = 49, location = "Beaucedine Glacier", bait = "Sabiki Rig", rod = "Halcyon Rod" },
	{ name = "Istakoz", skill = 46, location = "Arrapago Reef, Nashmau, Talacca Cove", bait = "Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Istavrit", skill = 37, location = "Talacca Cove", bait = "Lugworm", rod = "Composite Fishing Rod" },
	{ name = "Istiridye", skill = 53, location = "Arrapago Reef, Nashmau", bait = "Ball of Crayfish Paste", rod = "Halcyon Rod" },
	{ name = "Jungle Catfish", skill = 80, location = "Yhoator Jungle, Yuhtunga Jungle", bait = "Ball of Sardine Paste, Ball of Trout Paste, Minnow", rod = "Composite Fishing Rod" },
	{ name = "Kalamar", skill = 48, location = "Aht Urhgan Whitegate, Mount Zhayolm, Silver Sea route to Al Zahbi, Silver Sea route to Nashmau", bait = "Slice of Bluetail", rod = "Halcyon Rod" },
	{ name = "Kalkanbaligi", skill = 105, location = "Silver Sea route to Al Zahbi, Silver Sea route to Nashmau", bait = "Shrimp Lure", rod = "Composite Fishing Rod" },
	{ name = "Kaplumbaga", skill = 53, location = "Caedarva Mire", bait = "Frog Lure", rod = "Halcyon Rod" },
	{ name = "Kayabaligi", skill = 75, location = "Al Zahbi, Bhaflau Thickets, Mamook, Wajaom Woodlands", bait = "Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Kilicbaligi", skill = 62, location = "Silver Sea route to Al Zahbi, Silver Sea route to Nashmau", bait = "Slice of Bluetail", rod = "Composite Fishing Rod" },
	{ name = "Lakerda", skill = 41, location = "Silver Sea route to Al Zahbi, Silver Sea route to Nashmau", bait = "Sinking Minnow", rod = "Composite Fishing Rod" },
	{ name = "Lamp Marimo", skill = 3, location = "Aydeewa Subterrane", bait = "Fly Lure, Lugworm, Sabiki Rig", rod = "Halcyon Rod" },
	{ name = "Lik", skill = 140, location = "Lufaise Meadows", bait = "Minnow, Sinking Minnow, Dwarf Pugil", rod = "Composite Fishing Rod" },
	{ name = "Lungfish", skill = 32, location = "Phanauet Channel", bait = "Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Mercanbaligi", skill = 86, location = "Arrapago Reef, Nashmau, Talacca Cove", bait = "Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Moat Carp", skill = 11, location = "Al Zahbi, Bastok Markets, Davoi, Dragon's Aery, East Sarutabaruta, Eastern Altepa Desert, Jugner Forest, Korroloka Tunnel, La Theine Plateau, Misareaux Coast, Northern San d'Oria, Port San d'Oria, Rabao, Rolanberry Fields, Temple of Uggalepih, The Boyahda Tree, West Ronfaure, West Sarutabaruta, Western Altepa Desert, Windurst Walls, Windurst Waters, Windurst Woods, Yhoator Jungle, Yuhtunga Jungle, Zeruhn Mines", bait = "Ball of Insect Paste", rod = "Halcyon Rod" },
	{ name = "Mola Mola", skill = 135, location = "Open sea route to Al Zahbi, Open sea route to Mhaura", bait = "Shrimp Lure", rod = "Composite Fishing Rod" },
	{ name = "Monke-Onke", skill = 51, location = "East Sarutabaruta, Giddeus, Yhoator Jungle, Yuhtunga Jungle", bait = "Shrimp Lure", rod = "Composite Fishing Rod" },
	{ name = "Moorish Idol", skill = 26, location = "Bibiki Bay, Manaclipper", bait = "Shrimp Lure, Worm Lure", rod = "Halcyon Rod" },
	{ name = "Morinabaligi", skill = 94, location = "Bhaflau Thickets, Wajaom Woodlands", bait = "Ball of Sardine Paste, Ball of Trout Paste", rod = "Halcyon Rod" },
	{ name = "Muddy Siredon", skill = 18, location = "Carpenters' Landing, Phanauet Channel", bait = "Frog Lure", rod = "Halcyon Rod" },
	{ name = "Nebimonite", skill = 27, location = "Sea Serpent Grotto, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Ball of Crayfish Paste", rod = "Halcyon Rod" },
	{ name = "Noble Lady", skill = 66, location = "Manaclipper, Open sea route to Al Zahbi, Open sea route to Mhaura, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Nosteau Herring", skill = 39, location = "Batallia Downs, Beaucedine Glacier, Lower Jeuno, Port Jeuno, Qufim Island", bait = "Ball of Sardine Paste, Lugworm, Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Ogre Eel", skill = 35, location = "East Sarutabaruta, South Gustaberg, West Sarutabaruta", bait = "Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Phanauet Newt", skill = 4, location = "Carpenters' Landing, Phanauet Channel", bait = "Fly Lure", rod = "Halcyon Rod" },
	{ name = "Pipira", skill = 29, location = "East Sarutabaruta, Windurst Walls, Windurst Waters, Windurst Woods, Yhoator Jungle, Yuhtunga Jungle", bait = "Minnow", rod = "Halcyon Rod" },
	{ name = "Pterygotus", skill = 99, location = "Nashmau", bait = "Lugworm", rod = "Composite Fishing Rod" },
	{ name = "Quus", skill = 19, location = "Bibiki Bay, Cape Teriggan, Den of Rancor, East Sarutabaruta, Kazham, Korroloka Tunnel, Lufaise Meadows, Manaclipper, Misareaux Coast, Norg, Port Bastok, Port Windurst, Sea Serpent Grotto, Selbina, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates), South Gustaberg, Valkurm Dunes, West Sarutabaruta", bait = "Lugworm", rod = "Halcyon Rod" },
	{ name = "Red Terrapin", skill = 53, location = "Davoi, Ghelsba Outpost, Giddeus, Jugner Forest, La Theine Plateau, Pashhow Marshlands, Phanauet Channel, Rolanberry Fields, The Sanctuary of Zi'Tah, West Ronfaure", bait = "Frog Lure", rod = "Halcyon Rod" },
	{ name = "Rhinochimera", skill = 72, location = "Arrapago Reef", bait = "Sinking Minnow", rod = "Composite Fishing Rod" },
	{ name = "Ryugu Titan", skill = 150, location = "Den of Rancor, Manaclipper, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Slice of Cod", rod = "Composite Fishing Rod" },
	{ name = "Sandfish", skill = 50, location = "Eastern Altepa Desert, Korroloka Tunnel, Kuftal Tunnel, Rabao, Western Altepa Desert", bait = "Worm Lure", rod = "Halcyon Rod" },
	{ name = "Sazanbaligi", skill = 56, location = "Al Zahbi, Bhaflau Thickets, Mamook, Wajaom Woodlands", bait = "Ball of Insect Paste, Little Worm, Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Sea Zombie", skill = 100, location = "Ship bound for Mhaura (with Pirates), Ship bound for Selbina (with Pirates)", bait = "Drill Calamary, Meatball, Slice of Bluetail", rod = "Composite Fishing Rod" },
	{ name = "Shall Shell", skill = 53, location = "Bibiki Bay, Buburimu Peninsula, Cape Teriggan, Valkurm Dunes", bait = "Robber Rig", rod = "Halcyon Rod" },
	{ name = "Shining Trout", skill = 37, location = "Carpenters' Landing, East Ronfaure, Ghelsba Outpost, Jugner Forest, Phanauet Channel", bait = "Fly Lure, Minnow, Sinking Minnow", rod = "Halcyon Rod" },
	{ name = "Silver Shark", skill = 76, location = "Batallia Downs, Sauromugue Champaign, Sea Serpent Grotto, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Meatball", rod = "Halcyon Rod" },
	{ name = "Takitaro", skill = 101, location = "Davoi, Misareaux Coast", bait = "Fly Lure", rod = "Composite Fishing Rod" },
	{ name = "Tavnazian Goby", skill = 75, location = "Lufaise Meadows, Misareaux Coast", bait = "Minnow", rod = "Halcyon Rod" },
	{ name = "Three-Eyed Fish", skill = 79, location = "Qufim Island", bait = "Minnow, Slice of Cod", rod = "Composite Fishing Rod" },
	{ name = "Tiger Cod", skill = 29, location = "Batallia Downs, Beaucedine Glacier, Lower Jeuno, Port Jeuno, Qufim Island, Sauromugue Champaign", bait = "Lugworm, Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Tiny Goldfish", skill = 20, location = "Al Zahbi", bait = "Ball of Insect Paste, Little Worm, Worm Lure", rod = "Halcyon Rod" },
	{ name = "Titanic Sawfish", skill = 125, location = "Manaclipper", bait = "Meatball, Slice of Cod", rod = "Composite Fishing Rod" },
	{ name = "Titanictus", skill = 101, location = "Manaclipper, Ship bound for Mhaura, Ship bound for Mhaura (with Pirates), Ship bound for Selbina, Ship bound for Selbina (with Pirates)", bait = "Meatball", rod = "Composite Fishing Rod" },
	{ name = "Tricolored Carp", skill = 27, location = "Bastok Markets, Davoi, East Ronfaure, Ghelsba Outpost, Giddeus, Gusgen Mines, Jugner Forest, North Gustaberg, Northern San d'Oria, Palborough Mines, Phanauet Channel, Port San d'Oria, The Boyahda Tree, Zeruhn Mines", bait = "Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Tricorn", skill = 128, location = "Phanauet Channel", bait = "Fly Lure, Lufaise Fly", rod = "Composite Fishing Rod" },
	{ name = "Trilobite", skill = 59, location = "Bibiki Bay, Manaclipper", bait = "Worm Lure", rod = "Halcyon Rod" },
	{ name = "Turnabaligi", skill = 104, location = "Bhaflau Thickets, Wajaom Woodlands", bait = "Shrimp Lure", rod = "Composite Fishing Rod" },
	{ name = "Uskumru", skill = 55, location = "Silver Sea route to Al Zahbi, Silver Sea route to Nashmau", bait = "Minnow, Shrimp Lure", rod = "Halcyon Rod" },
	{ name = "Veydal Wrasse", skill = 35, location = "Open sea route to Al Zahbi, Open sea route to Mhaura", bait = "Slice of Bluetail", rod = "Composite Fishing Rod" },
	{ name = "Vongola Clam", skill = 53, location = "Bibiki Bay, Manaclipper", bait = "Ball of Crayfish Paste, Peeled Crayfish", rod = "Halcyon Rod" },
	{ name = "Yayinbaligi", skill = 31, location = "Caedarva Mire", bait = "Frog Lure, Minnow, Sinking Minnow, Worm Lure", rod = "Composite Fishing Rod" },
	{ name = "Yellow Globe", skill = 17, location = "Batallia Downs, Beaucedine Glacier, Buburimu Peninsula, Lower Jeuno, Mhaura, Norg, Open sea route to Al Zahbi, Open sea route to Mhaura, Port Jeuno, Qufim Island, Sauromugue Champaign", bait = "Ball of Crayfish Paste, Sabiki Rig, Worm Lure", rod = "Halcyon Rod" },
	{ name = "Yilanbaligi", skill = 47, location = "Al Zahbi, Bhaflau Thickets, Mamook, Wajaom Woodlands", bait = "Ball of Sardine Paste, Ball of Trout Paste, Little Worm, Peeled Crayfish, Shell Bug, Sinking Minnow, Worm Lure", rod = "Halcyon Rod" },
	{ name = "Zafmlug Bass", skill = 43, location = "Bibiki Bay, Cape Teriggan, Manaclipper, Port Bastok, Selbina, South Gustaberg, Valkurm Dunes", bait = "Worm Lure", rod = "Halcyon Rod" },
	{ name = "Zebra Eel", skill = 71, location = "Den of Rancor", bait = "Shrimp Lure, Slice of Sardine", rod = "Halcyon Rod" },
}
